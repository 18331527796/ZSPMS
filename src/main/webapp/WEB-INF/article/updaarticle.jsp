			...
			<div class="am-g tpl-amazeui-form">
				...
				<div class="am-u-sm-12 am-u-md-9">
					<form id="myform" name="myform" class="am-form am-form-horizontal"
						action="${pageContext.request.contextPath}/articleupdate.do" method="post" onsubmit="reutrn chk()">
						<input type="hidden" value="${ARTICLE.id}" name="id">
						<input type="hidden" value="${ARTICLE.crtime}" name="crtime"> 
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								...
								<small>标题名为不得小于2位的汉字<span id="titlemsg" style="float: r;"></span></small>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
							<textarea rows="10" cols="10" name="content" onblur="chkcontent()">${ARTICLE.content}</textarea>
								<small>内容长度不得为空且长度小于4000<span id="contentmsg" style="float: r;"></span></small>
							</div>
						</div>
						...
						<div class="am-form-group">
							...
							<div class="am-u-sm-9">
								<input type="text" id="author" value="${ARTICLE.author}" name="author"
									placeholder=">作者 / Author" style="float: left;" onblur="chkauthor()">
								<small>作者名字为不少于两位的汉字<span id="authormsg" style="float: r;"></span></small>
							</div>
						</div>
                                    ...
                                    <div class="am-u-sm-9">
                                      ...
                                      <select name="channel" style="width: 300px"id="pid">
                                   			...
                                   			<c:forEach items="${CHANNEL}" var="ch">
                                   					<c:if test="${ARTICLE.channel==ch.id}">
                                   					<option value="${ch.id}" selected="selected">${ch.cname}</option>
                                   					</c:if>
                                   					<c:if test="${ARTICLE.channel!=ch.id}">
                                   					<option value="${ch.id}">${ch.cname}</option>
                                   					</c:if>
                                   			</c:forEach>
                                      </select>
                                        <small></small>
						...
						<div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
	                                        ...
	                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                                        <input type="radio" name="isremod" checked="checked" value="0">不推荐
	                                   		</c:if>
                                        <small></small>
                        </div>
                        </div>
						...
						<div class="am-form-group">
                                  ...
                                  <c:if test="${ARTICLE.ishot==1}">
                                   ...
                                   <c:if test="${ARTICLE.ishot==0}">
                                        <input type="radio" name="ishot"  value="1">是热点&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        &nbsp;&nbsp;&nbsp;
                                        <input type="radio" name="ishot" checked="checked" value="0">不是热点
                                   </c:if>
                                        <small></small>
                                    </div>
                        </div>
