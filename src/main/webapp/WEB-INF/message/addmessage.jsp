...
<head>
  ...
  $(function() {
    ...
    function chk() {
		return chkcman()&&chkcontent()&&chktitle();
	}
            ...
            <div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 广告新增
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form id="myform" name="myform" class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/messageadd.do?page=${PAGE>1?PAGE-1:1}" method="post" onsubmit="return chk()">
                              
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">标题 / Title</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" id="title" name="title" placeholder="标题 / Title"  style="float: left;" onblur="chktitle()">
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                         <textarea rows="30" cols="30" name="content" id="content" onblur="chkcontent()"></textarea> 
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="ctime" name="ctime" value="2018-12-19" class="am-form-field tpl-form-no-bg" placeholder="公告时间 " data-am-datepicker="" readonly/>
                                        <small></small>
                                    </div>
                                </div>
                                 ...
                                 <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        <input type="text" id="cman"  name="cman" placeholder="公告人 / Cman" onblur="chkcman()">
